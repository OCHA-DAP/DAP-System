                ...
                <div style="width:50%" class="tab-pane" id="region" ng-controller="RegionDictionariesCtrl">
                    ...
                    <form novalidate name="createResourceForm" class="css-form">
                        <table class="table table-bordered table-hover table-condensed">
                            ...
                            <tr>
                                <td>
                                    <select class="form-control" id="newResource_entity" ng-model="newResource.entityId" ng-options="entity.id as entity.entityTypeName+'/'+entity.name for entity in entities" ng-class="default" required></select>
                                </td>
                                <td>
