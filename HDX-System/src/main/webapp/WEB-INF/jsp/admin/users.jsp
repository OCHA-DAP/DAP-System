		...
		<div>
			<table class="table table-bordered table-hover table-condensed">
				...
				<tr ng-repeat="user in users | orderBy:predicate:reverse">
					...
					<td><span editable-text="user.password2" e-class="form-control" e-name="password2" e-id="password2_field" e-form="rowform" onshow="customize('password2_field')"> {{ user.password2 }}
						</span></td>
