			...
			<form novalidate name="createResourceForm" class="css-form">
				<table class="table table-bordered table-hover table-condensed">
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<label for="newResource_valueType">Value type</label> <select class="form-control" id="newResource_valueType" ng-model="newResource.valueType"
									ng-options="v.value as v.text for v in valueTypes" ng-class="default" required>
								</select>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="newResource_initialValue">Initial value</label> <input type="text" class="form-control" placeholder="Initial value" id="newResource_initialValue"
									ng-model="newResource.initialValue" required />
							</div>
						</td>
						<td style="white-space: nowrap">
			...
			<table class="table table-bordered table-hover table-condensed">
				...
				<tr ng-repeat="indicator in indicators | orderBy:predicate:reverse">
					...
					<td>
						...
						e-ng-options="v.value as v.text for v in periodicities"> {{ indicator.processedPeriodicity }} </span --> <span editable-text="indicator.processedPeriodicity" e-class="form-control"
							e-name="processedPeriodicity" e-form="rowform" required> {{ indicator.processedPeriodicity }} </span>
					</td>
					<td>
					...
					<td>
						<!-- editable import from CKAN --> <span editable-text="indicator.processedImportFromCkan" e-class="form-control" e-name="processedImportFromCkan" e-form="rowform" required> {{
							indicator.processedImportFromCkan}} </span>
					</td>
					<td style="white-space: nowrap">
						<!-- form -->
