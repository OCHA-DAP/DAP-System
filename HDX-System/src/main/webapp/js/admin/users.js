...
app.controller('UsersCtrl', function($scope, $filter, $http) {
  ...
  $scope.loadUsers = function() {
    return $http.get(hdxContextRoot + '/admin/misc/users/json').success(function(data) {
      $scope.users = data;
  ...
  $scope.loadRoles = function() {
    return $http.get(hdxContextRoot + '/admin/misc/users/roles/json').success(function(data) {
      $scope.roles = data;
      $scope.resetNewUser();
    });
  };
  ...
  $scope.saveUser = function(datas, id) {
    ...
    if ("OK" === valid) {
      return $http.post(
          hdxContextRoot + '/admin/misc/users/submitupdate',
  ...
  $scope.removeUser = function(id) {
    ...
    $http.post(hdxContextRoot + '/admin/misc/users/submitdelete', "userId=" + id, {
      headers : {
        'Content-Type' : 'application/x-www-form-urlencoded'
      }
    }).success(function(data, status, headers, config) {
  ...
  $scope.addUser = function(data) {
    ...
    if ("OK" === valid) {
      // alert("Add user : " + data);
      return $http.post(
          hdxContextRoot + '/admin/misc/users/submitadd',
