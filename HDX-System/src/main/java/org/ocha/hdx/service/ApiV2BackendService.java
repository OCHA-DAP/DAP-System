...
public interface ApiV2BackendService {
	...
	ApiResultWrapper<ApiIndicatorValue> listIndicatorsByCriteriaWithPagination(List<String> indicatorTypeCodes, List<String> sourceCodes, List<String> entityCodes, Integer startYear, Integer endYear,
			PeriodType periodType, Integer pageNum, Integer pageSize, String lang);
	 ...
	 * @return a list of ApiIndicatorValue wrapped with information about results,pagination,etc
	 */
	ApiResultWrapper<ApiIndicatorValue> listIndicatorsByCriteria(List<String> indicatorTypeCodes, List<String> sourceCodes, List<String> entityCodes, Integer startYear, Integer endYear,
			final PeriodType periodType, String lang);
}
