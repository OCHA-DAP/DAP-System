...
/**
 * Exporter for a country FTS - readme.
 * 
 * @author bmichiels
 * 
 */
public class ExporterCountryFTSReadme_TXT extends Exporter_File<ExporterCountryQueryData> {

	public ExporterCountryFTSReadme_TXT(final ExporterService exporterService) {
		super(exporterService);
	}

	public ExporterCountryFTSReadme_TXT(final Exporter<File, ExporterCountryQueryData> exporter) {
		super(exporter);
	}
