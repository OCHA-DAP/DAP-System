...
@ContextConfiguration(locations = { "classpath:/ctx-config-test.xml", "classpath:/ctx-core.xml", "classpath:/ctx-dao.xml", "classpath:/ctx-integration-test.xml", "classpath:/ctx-persistence-test.xml" })
public class IndicatorDAOImplTest {
	...
	public void testListIndicatorsForCountryCrisisHistory() {
		...
		final Map<Integer, List<Object[]>> listIndicatorsForCountryCrisisHistory = indicatorDAO.listIndicatorsForCountry("USA", 2005, 2010, "FR", DataSerie.COUNTRY_CRISIS_HISTORY_dataSeries);
