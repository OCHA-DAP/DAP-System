...
public class IndicatorDAOImplTest {
	...
	public void testListLastIndicators() {
		...
		try {
			indicatorDAO.createIndicator(sourceWB, russia, perCapitaGdp, date2013, date2014, Periodicity.YEAR, new IndicatorValue(10000.0), "10000$", importFromCKAN);
		...
		indicatorDAO.createIndicator(sourceWB, russia, perCapitaGdp, date2013, date2013Feb, Periodicity.MONTH, new IndicatorValue(10000.0), "10000$", importFromCKAN);

		indicatorDAO.createIndicator(sourceAcled, russia, perCapitaGdp, date2013, date2014, Periodicity.YEAR, new IndicatorValue(9000.0), "9000$", importFromCKAN);
		...
		indicatorDAO.createIndicator(sourceAcled, luxembourg, perCapitaGdp, date2013, date2014, Periodicity.YEAR, new IndicatorValue(100000.0), "100000$", importFromCKAN);
		...
		indicatorDAO.createIndicator(sourceWB, luxembourg, perCapitaGdp, date2012, date2013, Periodicity.YEAR, new IndicatorValue(273.97), "237.97$ per day", importFromCKAN2);
		...
		indicatorDAO.createIndicator(sourceWB, russia, perCapitaGdp, date2012, date2013, Periodicity.YEAR, new IndicatorValue(273.97), "237.97$ per day", importFromCKAN2);
		...
		indicatorDAO.createIndicator(sourceWB, russia, pvx040, date2013, date2014, Periodicity.YEAR, new IndicatorValue(273.97), "237.97$ per day", importFromCKAN2);
		Assert.assertEquals(1, indicatorDAO.listIndicatorsByYearAndSourceAndIndicatorTypes(2013, "WB", indicatorTypesOnlyPerCapita).size());
		Assert.assertEquals(1, indicatorDAO.listIndicatorsByYearAndSourceAndIndicatorType(2013, "WB", "per-capita-gdp", null).size());
