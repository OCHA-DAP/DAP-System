...
public interface FileEvaluatorAndExtractor {
	...
	/**
	 * Performs the evaluation of the resource, using the appropriate evaluator
	 * (Dummy evaluator, ScrapperEvaluator etc...)
	 * 
	 * @return
	 */
	...
	/**
	 * Performs the required transformation and import data of the resource,
	 * using the appropriate importer (Dummy importer, ScrapperImporter etc...)
	 * 
	 * @return
	 */
